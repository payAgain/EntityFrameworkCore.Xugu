...
/// <summary>
///     "WHERE boolColumn" may not use available indices; "WHERE boolColumn = TRUE" does.
/// </summary>
public class XuguBoolOptimizingExpressionVisitor : SqlExpressionVisitor
{
    private bool _optimize;
    private readonly ISqlExpressionFactory _sqlExpressionFactory;

    public XuguBoolOptimizingExpressionVisitor(
        ISqlExpressionFactory sqlExpressionFactory)
    {
        ...
        private Expression ApplyConversion(SqlExpression sqlExpression, bool condition)
        {
            if (_optimize &&
                ...
                sqlExpression.TypeMapping is XuguBoolTypeMapping &&
        ...
        {
            ArgumentNullException.ThrowIfNull(caseExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(distinctExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(fromSqlExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(likeExpression);
        ...
        protected override Expression VisitSqlBinary(SqlBinaryExpression sqlBinaryExpression)
        {
            ...
            if (_optimize &&
                ...
                columnExpression.TypeMapping is XuguBoolTypeMapping &&
                columnExpression.Type == typeof(bool) &&
                sqlConstantExpression.TypeMapping is XuguBoolTypeMapping &&
        ...
        {
            ArgumentNullException.ThrowIfNull(sqlConstantExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(sqlFragmentExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(sqlParameterExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(crossJoinExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(innerJoinExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(leftJoinExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(scalarSubqueryExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(rowNumberExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(exceptExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(intersectExpression);
        ...
        {
            ArgumentNullException.ThrowIfNull(unionExpression);
