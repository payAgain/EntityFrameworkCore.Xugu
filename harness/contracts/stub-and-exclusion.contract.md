...
### 7.3 测试 Skip（W3 收口 — defer → excluded/blocked）

| 测试 | 原因 | disposition |
|------|------|-------------|
| `OptimisticConcurrencyTests.Stale_*` | E10049 ROW_COUNT | **blocked** → W5 |
...
| `LazyLoadTests` ×1 | 无 proxy 宿主 | **excluded-with-evidence** → W4 |
| `SeedingTests.EnsureCreated_HasData` | HasData + EnsureCreated | **blocked** → W4/W5 |
