...
## 当前 Phase: **7**（`active` — 1.0.0 生产级发版）

**版本**：`0.1.0-preview` → 目标 **`1.0.0`**  
**测试**：**141/141** PASS  
...
| **7** | **1.0.0 生产级发版** | **`active`** | **`1.0.0`** | ExecuteDelete/Update、编译管道、LIMITATIONS、pack |
...
| 优先级 | 范围 | 任务数 |
|--------|------|--------|
| P0 | ExecuteDelete/Update、编译管道、TypeMapping、冒烟测试、LIMITATIONS | 11 |
| P1 | Retry 文档化、EvaluatableFilter、NuGet 脚本、CHANGELOG | 5 |
| **合计** | 7.R/Q/S/T/O/V | **16** |

**关键路径**：`7.Q2` → `7.Q4` → `7.Q1` → `7.O1` → `7.T1` → `7.V1`

**可并行 W1**：`7.R1`, `7.R2`, `7.R4`, `7.Q2`, `7.S1`, `7.S2`
...
| 项 | Phase | 说明 |
|----|-------|------|
| `XuguRetryingExecutionStrategy` | 7 | 驱动瞬态码未稳定 → 实装或 LIMITATIONS |
