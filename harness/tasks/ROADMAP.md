...
## 当前 Phase: **11**（**in_progress** — 2.1.0 ✅；完全体 W11–W15）

**版本**：**`2.1.0`**（`v2.1.0` tag @ 6dc0c72）→ 目标 **`3.0.0`** 完全体  
**测试**：compat **896** / ~1050（~85%）；native **177**  
**源码**：**139** / 194 .cs（~72%）  
...
Pomelo 9.0.0 测试对等 (2.0.0)
        ↓ Phase 10 ✓
维护 / 剩余对等 (2.0.x)
        ↓ Phase 11 (current — in_progress)
Xugu 原生方言 2.1.0 ✅ → Pomelo 完全体 3.0.0
```
...
| **11** | **Xugu 原生方言 / 完全体** | **`in_progress`** | **2.1.0** ✅ → **3.0.0** | 2.1.0 tag ✅；W11–W15 100% parity 待收口 |
...
| **11 偏差修复轨** | **`harness/tasks/phase-11-xugu-native-release/NATIVE-DIALECT-ROADMAP.md`**（W3–5 + W10：**done** — 11.M5–M7 ✅） |
| **11 Release Gate 缺口** | **`harness/tasks/phase-11-xugu-native-release/RELEASE-GATE-GAPS.md`**（W10 2.1.0：**closed**） |
| **11 完全体收尾** | **`harness/tasks/phase-11-xugu-native-release/PHASE11-CLOSURE-CRITERIA.md`**（W11–W15；11.M8–M10） |
...
## Phase 11 — Xugu 原生方言 + Pomelo 完全体（**in_progress**）

> **任务详情**：`harness/tasks/phase-11-xugu-native-release/TASKS.md`  
> **完全体标准**：`PHASE11-CLOSURE-CRITERIA.md`  
> **2.1.0 Release Gate（W10）**：`RELEASE-GATE-GAPS.md` — **closed** @ 6dc0c72  
> **前置**：Phase 10 `done`（**2.0.0**）；2.1.0 功能发布 ✅
...
3. **完全体 100% Pomelo Parity**（W11–W15）：测试 Comparable Set 100%、源码 Comparable Files 100%、skip/defer/blocked 清零或 evidence-backed exclusion → **`v3.0.0` tag**。
...
| **11.M10** | **完全体 Release** | W13–W15 全绿；`v3.0.0` tag | **W15** | **todo** |
...
| **W11** | **11.801–11.815** | Test parity | 2.1.0 tag | 11.M8 | **todo** |
| **W12** | **11.901–11.915** | Feature parity | W11 inventory | 11.M9 | **todo** |
| **W13** | **11.1001–11.1010** | Platform | — | ROW_COUNT/RID | **todo** |
| **W14** | **11.1101–11.1115** | Skip modules | W11.806 | OUT OF SCOPE 空 | **todo** |
| **W15** | **11.1201–11.1210** | 完全体 Gate | W11–W14 | `v3.0.0` tag | **todo** |
...
| 日期 | 事件 |
|------|------|
| 2026-07-09 | **Phase 11 完全体重规划（实测审计）**：compat **896**、native **177**、707 属性/157 测试 .cs；PHASE11-CLOSURE-CRITERIA + W11–W15；ROADMAP/BACKLOG 漂移修复 |
