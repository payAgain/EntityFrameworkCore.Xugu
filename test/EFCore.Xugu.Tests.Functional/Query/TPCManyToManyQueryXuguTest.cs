...
public class TPCManyToManyQueryXuguTest : TPCManyToManyQueryRelationalTestBase<TPCManyToManyQueryXuguFixture>
{
    public TPCManyToManyQueryXuguTest(TPCManyToManyQueryXuguFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
