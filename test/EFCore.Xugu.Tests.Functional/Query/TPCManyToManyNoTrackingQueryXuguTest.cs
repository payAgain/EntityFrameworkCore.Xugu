...
public class TPCManyToManyNoTrackingQueryXGTest : TPCManyToManyNoTrackingQueryRelationalTestBase<TPCManyToManyQueryXuguFixture>
{
    public TPCManyToManyNoTrackingQueryXGTest(TPCManyToManyQueryXuguFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
