...
public sealed class MonsterFixupFixture : XuguSharedStoreFixture<MonsterFixupXuguTests.MonsterFixupContext>
{
    ...
    {
        TestStore.TryExecuteNonQueries(
            $"DROP TABLE {TestStore.FormatTableName("MF_BOOK_AUTHOR")} CASCADE",
            $"DROP TABLE {TestStore.FormatTableName("MF_BOOK")} CASCADE",
            $"DROP TABLE {TestStore.FormatTableName("MF_AUTHOR")} CASCADE",
            $"DROP TABLE {TestStore.FormatTableName("MF_NODE")} CASCADE",
            $"DROP TABLE {TestStore.FormatTableName("MF_TAG")} CASCADE",
            $"DROP TABLE {TestStore.FormatTableName("MF_DETAIL")} CASCADE",
            $"DROP TABLE {TestStore.FormatTableName("MF_PRODUCT")} CASCADE",
            $"DROP TABLE {TestStore.FormatTableName("MF_CATEGORY")} CASCADE");
        ...
        TestStore.ExecuteNonQueries(
            ...
            """,
            $"ALTER TABLE {category} ALTER COLUMN ID INTEGER IDENTITY(1, 1) PRIMARY KEY",
            $"""
            ...
            """,
            $"ALTER TABLE {product} ALTER COLUMN ID INTEGER IDENTITY(1, 1) PRIMARY KEY",
            $"""
            CREATE TABLE {detail} (
            ...
            """,
            $"ALTER TABLE {tag} ALTER COLUMN ID INTEGER IDENTITY(1, 1) PRIMARY KEY",
            $"""
            CREATE TABLE {node} (
            ...
            """,
            $"ALTER TABLE {author} ALTER COLUMN ID INTEGER IDENTITY(1, 1) PRIMARY KEY",
            $"""
            CREATE TABLE {book} (
                ID INTEGER NOT NULL,
            ...
            """,
            $"ALTER TABLE {book} ALTER COLUMN ID INTEGER IDENTITY(1, 1) PRIMARY KEY",
            $"""
    ...
    public void SeedAuthorsAndBooks()
    {
        ...
        TestStore.ExecuteNonQueries(
            $"INSERT INTO {author} (ID, NAME) VALUES (1, 'A1')",
            $"INSERT INTO {book} (ID, TITLE) VALUES (1, 'B1'), (2, 'B2')");
    }
